<footer class="w-full px-4 bg-dark text-white">
    <div class="max-w-4xl m-auto py-[60px] grid grid-cols-2 gap-6 border-b border-white/10 475px:grid-cols-1">
        <div class="flex flex-col">
            <img src="{{ asset('assets/neon_tranp_white.png') }}" width="148" alt="NeonExpression icon">
            <p class="mb-3 py-3 border-b border-white/5 text-sm">Welcome to NeonExpression, your one-stop-shop for buying and creating custom neon signs. We offer a wide variety of pre-made neon signs for purchase, as well as the option to create your own personalized neon sign</p>
            ...
            <address class="flex items-center mb-3"><img class="mr-2" src="https://api.iconify.design/mdi:gmail.svg?color=%23dbdbdb" width="25" alt="Address Icon"> contact@neonexpression.com</address>
            <ul class="flex items-center">
                <a class="mr-4" href="https://www.instagram.com/neonexpression/" rel="nofollow" target="_blank"><img src="https://api.iconify.design/skill-icons:instagram.svg?color=%23f91a1a" width="25" alt="Social Media Icon"></a>
    ...
    <p class="py-6 text-center">
        Copyrights &copy; {{ date('Y') }} | NeonExpression All Reserved
    </p>
</footer>