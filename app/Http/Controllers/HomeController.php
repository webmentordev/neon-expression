...
class HomeController extends Controller
{
    public function index(){
        ...
        OpenGraph::addImage("https://neonexpression.com/assets/seo/home-2.png");
        OpenGraph::addImage("https://neonexpression.com/assets/seo/home-1.png", ["height" => 400, "width" => 760]);

        TwitterCard::setTitle("Buy Custom Neon Signs | Neon Expression");
        TwitterCard::setSite("@neonexpression");
        TwitterCard::setImage("https://neonexpression.com/assets/seo/home-2.png");
        ...
        JsonLd::addImage("https://neonexpression.com/assets/seo/home-2.png");
        JsonLd::setType("WebSite");
        JsonLd::addImage("https://neonexpression.com/assets/seo/home-1.png", ["height" => 400, "width" => 760]);
